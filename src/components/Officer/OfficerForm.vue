        ...
        <form v-on:submit.prevent="saveOfficer()">
            <div class="grid grid-cols-12 gap-4 mb-6">
                ...
                <div class="col-span-12 md:col-span-6">
                    ...
                    <input v-model="officer.lastname" type="text" id="lastname" placeholder="Lastname" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="col-span-12 md:col-span-8">
                    ...
                    <input v-model="officer.email" type="email" id="email" placeholder="Email" required class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                ...
                <div class="col-span-12 md:col-span-4">
                    ...
                    <select v-model="officer.sex" id="sex" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
...
import useOfficer from '@/composables/officerforms'
...
const { getOfficer, storeOfficer, updateOfficer, officer, errors } = useOfficer()

onMounted(() => {
    getSelectionColleges()

    var officer_id: string = route.params.id as string
    if (Number(officer_id)) {
        getOfficer(Number(officer_id))
        breadcrumbs.value[1].name = `Form ${(route.params.id as string).length == 0 ? 'Create' : 'Update'}`
    }
})

const saveOfficer = async () => {
    var officer_id: string = route.params.id == null ? '' : route.params.id as string
    var isUpdate: boolean = officer_id.length != 0
    swal({
        ...
        if (agree) {
            if (Number(officer_id)) {
                updateOfficer(Number(officer_id))
            } else {
                storeOfficer()
            }
        }
